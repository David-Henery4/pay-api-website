...
const Testimonials = () => {
  return (
    <section className="bg-secondaryMirageBlue py-20 overflow-hidden col-start-1 col-end-13 grid grid-cols-mobColumns sm:grid-cols-tabColumns xl:grid-cols-deskColumns w-full desk:py-[100px]">
      <div className="relative w-full col-start-2 col-end-12 flex flex-col gap-14 items-center tab:gap-16 lg:flex-row-reverse lg:justify-between">
        <BgPattern className="pointer-events-none absolute w-[780px] h-[780px] bottom-3/4 md:bottom-[65%] lg:-left-[35%] lg:-bottom-[30%]"/>
        <TestimonialIconGrid/>
