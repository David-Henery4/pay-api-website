...
const StatsSection = () => {
  return (
    <section className="max-w-maxContentWidth mx-auto w-full py-4 border-y border-y-secondarySanJuanBlue/25 col-start-2 col-end-12 flex flex-col justify-center items-center gap-8 md:flex-row md:gap-[10px] md:border-y-0 lg:gap-[30px]">
